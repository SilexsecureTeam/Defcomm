...
import { FaDesktop, FaWaveSquare, FaWifi, FaVolumeUp, FaSignal } from "react-icons/fa";
import { RiBatteryChargeFill } from "react-icons/ri"
import {PiChatCircleTextBold} from "react-icons/pi"
import { IoMdFlame } from "react-icons/io";

const broadcasts = [
    { title: "Intel Ops", color: "bg-green-500", progress: 70, profileColor: "#759719" },
    { title: "Weapon Tracking", color: "bg-red-500", progress: 50, profileColor: "#8B0A1A" },
    { title: "Special Operations", color: "bg-yellow-500", progress: 50, profileColor:"#CDB30A" },
];
    ...
    return (
        <div className="p-2">
            ...
            {broadcasts.map((item, index) => (
                <div key={index} className="mb-4 bg-gray-200 text-gray-800 font-medium flex min-h-24">
                    <div className="bg-blue-600 w-12 min-h-full flex flex-col justify-between items-center p-2 text-white"
                    ...
                    <section className="gap-2 p-3 w-full">
                        <div className=" w-full flex flex-col md:flex-row md:flex-wrap justify-between gap-2">
                            ...
                            <div className="flex items-center space-x-3 w-max cursor-pointer">
                        ...
                        <div className="mt-2">
                        <AudioVisualizer progress={item?.progress || 50} fillColor={index >0 ? "#FF0000" : null}  width={200} />
                        </div>
                    </section>
