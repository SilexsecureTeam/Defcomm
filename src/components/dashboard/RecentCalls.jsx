  ...
  return (
    <div className="p-2">
      ...
      {calls.map((call, index) => (
        <div key={index} className="text-sm flex gap-2 items-center mt-2 bg-gray-800 text-white even:text-gray-900 even:bg-oliveGreen min-h-[70px] p-2">
          <figure className="w-12 h-12 rounded-full bg-gray-50">
