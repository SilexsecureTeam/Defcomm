  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed right-4 bottom-20 w-64 max-h-[60vh] overflow-y-auto bg-white border border-gray-300 shadow-md rounded-md p-4 pt-0 z-50"
      >
        <div className="sticky top-0 pt-4 bg-white flex justify-between items-center mb-2 border-b pb-2">
          <h3 className="text-oliveLight font-semibold">
