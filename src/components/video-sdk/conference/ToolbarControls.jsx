  ...
  return (
    <div className="relative sticky mt-auto bottom-0 bg-black/70 flex flex-wrap justify-center items-center gap-4 px-3 py-3 text-xl sm:text-2xl z-10">
      ...
      <div className="relative">
        ...
        {showReactions && (
      <div className="absolute bottom-14 left-1/2 transform -translate-x-1/2 max-w-1/2 bg-white text-black rounded-lg shadow-lg px-3 py-2 flex justify-center gap-2 flex-wrap z-50">
  {emojiList.map((emoji) => (
    <button
      key={emoji}
      onClick={() => {
