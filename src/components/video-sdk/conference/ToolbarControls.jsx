  ...
  return (
    <div className="relative sticky mt-auto bottom-0 bg-black/70 flex flex-wrap justify-center items-center gap-4 px-3 py-3 text-xl sm:text-2xl z-10">
      ...
      <div className="relative">
        ...
        {showReactions && (
      <div className="absolute bottom-12 -left-1/2 md:left-1/2 -translate-x-1/2 bg-white text-black rounded-lg shadow-lg px-2 py-1 flex gap-2 z-50 max-w-[90vw] overflow-x-auto whitespace-nowrap scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
          {emojiList.map((emoji) => (
              <button
                key={emoji}
                onClick={() => {
