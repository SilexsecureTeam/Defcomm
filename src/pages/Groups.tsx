  ...
  return (
    <div className="p-6 text-white flex flex-col gap-6">
        ...
        <section className="bg-gray-500 p-5 rounded-lg">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-medium">
              <strong className="text-oliveHover">
      ...
      <section className="bg-white p-5 rounded-lg">
        <h2 className="text-2xl font-semibold mb-4 text-oliveDark">
          Pending Invitations
        </h2>
        {loadingInvitations ? (
          <div className="flex justify-center">
          ...
          <ul className="space-y-4">
            {invitations.map((inv) => (
              <li
                key={inv?.id}
                className="p-4 rounded-lg flex flex-col md:flex-row justify-between md:items-center shadow-md gap-1"
              >
                <span className="text-xl md:text-lg font-medium text-olive">
                  {inv?.group_name}
                </span>
